...
`limits.dimension: elapsed_time`. Release validation now exercises behavioral
gates plus installation and MCP discovery from the final local NuGet artifact.
See [the 0.2.1 to 0.2.2 migration guide](docs/migrating-0.2.1-to-0.2.2.md).
