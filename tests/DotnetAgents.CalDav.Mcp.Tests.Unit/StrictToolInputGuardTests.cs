...
public sealed class StrictToolInputGuardTests
{
    ...
    [InlineData("todos.query", null, false, null)]
    [InlineData("todos.query", 262_144, false, null)]
    [InlineData("todos.query", 262_145, false, "payload_too_large")]
    [InlineData("todos.query", 1, true, "invalid_input")]
    ...
    [InlineData("calendars.create", 262_144, false, null)]
    [InlineData("calendars.create", 262_145, true, "payload_too_large")]
    [InlineData("calendars.create", 1, true, "invalid_input")]
    [InlineData("calendars.delete", 262_144, false, null)]
    [InlineData("calendars.delete", 262_145, true, "payload_too_large")]
    [InlineData("calendars.delete", 1, true, "invalid_input")]
