...
public sealed class CalendarEntityPatchMatrixTests
{
    ...
    public async Task Every_structured_collection_maps_to_its_exact_property_or_component()
    {
        ...
        var cases = new (ICalendarCollectionPatch Patch, string Expected)[]
        {
            ...
            (Add(CalendarCollectionField.StyledDescriptions, text), "STYLED-DESCRIPTION;VALUE=TEXT:Value"),
            (Add(CalendarCollectionField.Images, named), "IMAGE;VALUE=URI;LABEL=Label:https://example.test/value"),
            (Add(CalendarCollectionField.Conferences, named), "CONFERENCE;VALUE=URI;LABEL=Label:https://example.test/value"),
