...
seed_main_artifacts() {
  ...
  write_successful_trx "$directory/main-core.trx" 1745
  write_successful_trx "$directory/main-mcp.trx" 941
  write_successful_trx "$directory/main-integration.trx" 88
}
...
write_successful_trx "$below_minimum/main-core.trx" 1744
